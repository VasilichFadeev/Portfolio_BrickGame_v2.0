...
namespace s21 {
/**
 * @brief Спавнит змейку в случайной позиции на поле.
 *
 * - Использует генератор случайных чисел для выбора координат.
 * - Проверяет, чтобы выбранное место было свободным.
 * - Создает змейку из 4 сегментов, расположенных вертикально.
