...
/**
 * @brief Формирует HTML-представление игрового поля для отображения
 *
 * Генерирует HTML-таблицу с игровым полем, текущей фигурой, следующей фигурой
 * и статистикой (счёт, уровень, рекорд). Цвета фигур учитываются.
 *
 * @return QString с HTML-кодом игрового поля
 */
namespace s21 {
